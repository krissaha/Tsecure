...
public class ReturnUserRegistration extends TestBase {
	...
	@Test(enabled = true)
	public void return_user_dashboard_Click_All() throws Throwable { // This Test case will run for return user
																		// registration
