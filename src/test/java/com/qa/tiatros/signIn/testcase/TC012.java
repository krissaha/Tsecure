/*** Click on the Didn't receive unlock instructions link and input invalid Email in the textbox and press send button  ***/
...
public class TC012 extends TestBase {
	...
	// the UI design
	@Test
	public void tc012_signIN() throws Throwable {
