/*** Click on the Didn't receive confirmation instructions link and input invalid Email in the textbox and press send button , check the validation message     **/
