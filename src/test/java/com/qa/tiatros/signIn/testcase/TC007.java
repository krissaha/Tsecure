/*** Click on the Didn't receive confirmation instructions link and input valid Email in the textbox and press send button , check the validation message   **/
